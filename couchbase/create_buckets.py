...
#os.system("curl -X POST -u username:password -d name=tags -d ramQuotaMB=100 -d authType=none -d replicaNumber=3 -d proxyPort=11218 http://localhost:8091/pools/default/buckets")
os.system("curl -X POST -u username:password -d name=memoir -d ramQuotaMB=100 -d authType=none -d replicaNumber=3 -d proxyPort=11218 http://localhost:8091/pools/default/buckets")
